...
videoInfo2 = Video.create!(user_id: user2.id, views: 7, title:"Alternate Reality Dynasties", description:"3 Future MVPs, now just Steven Adams.", category:"History", tags:["nba", "thunder", "dynasty","KD","snakes","Mr Thunder"], comment_visibility: true)
videoInfo3 = Video.create!(user_id: user9.id, views: 765, title:"BIG Color", description:"Still better than the sleeved jerseys. Comment below on your favorite.", category:"Fashion", tags:["color", "nba", "BIG", "marketing"], comment_visibility: true)
videoInfo4 = Video.create!(user_id: user3.id, views: 52312, title:"You Miss 100% of the Hesi Pullup Fadeaways You Don't Take", description:"5 seconds on the clock, with 2 shooters wide open...Do you take the shot, or do you take the shot?", category:"Lifestyle", tags:["nba", "midrange", "style","mamba","KOBE"], comment_visibility: true)
