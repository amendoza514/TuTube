...
user5 = User.create!(email: "demo_user@gmail.com", password:"123456", verified: false, icon_color: '#c4302b')
...
videoInfo4 = Video.create!(user_id: user3.id, views: 52312, title:"You Miss 100% of the Hesi Pullup Bankers You Don't Take", description:"5 seconds on the clock, with 2 shooters wide open...Do you take the shot, or do you take the shot?", category:"Lifestyle", tags:["nba", "midrange", "style"], comment_visibility: true)
...
videoInfo7 = Video.create!(user_id: user1.id, views: 96352, title:"GOATS || Part 3: Choosing your Footwear", description:"Goats need particular attention when it comes to picking footwear for the job at hand. Here are some helpful tips on picking the right fit", category: "Animals", tags:["GOAT", "nba"], comment_visibility: false)
